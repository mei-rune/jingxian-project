...
namespace jingxian.ui.controls.renderer
{
    public class Office2007Renderer : ToolStripProfessionalRenderer
    {
        ...
        public class GradientItemColors
        {
            ...
            public GradientItemColors Clone()
            {
                return new GradientItemColors(
                    InsideTop1,
                    InsideTop2,
                    InsideBottom1,
                    InsideBottom2,
        ...
        protected static int _gripOffset = 1;
        protected static int _gripSquare = 2;
        protected static int _gripSize = 3;
        protected static int _gripMove = 4;
        protected static int _gripLines = 3;
        protected static int _checkInset = 1;
        protected static int _marginInset = 2;
        protected static int _separatorInset = 31;
        protected static float _cutToolItemMenu = 1.0f;
        protected static float _cutContextMenu = 0f;
        protected static float _cutMenuItemBack = 1.2f;
        protected static float _contextCheckTickThickness = 1.6f;
        protected static Blend _statusStripBlend;
        #endregion

        #region Static Colors
        protected static Color _c1 = Color.FromArgb(167, 167, 167);
        protected static Color _c2 = Color.FromArgb(21, 66, 139);
        protected static Color _c3 = Color.FromArgb(76, 83, 92);
        protected static Color _c4 = Color.FromArgb(250, 250, 250);
        protected static Color _c5 = Color.FromArgb(248, 248, 248);
        protected static Color _c6 = Color.FromArgb(243, 243, 243);
        protected static Color _r1 = Color.FromArgb(255, 255, 251);
        protected static Color _r2 = Color.FromArgb(255, 249, 227);
        protected static Color _r3 = Color.FromArgb(255, 242, 201);
        protected static Color _r4 = Color.FromArgb(255, 248, 181);
        protected static Color _r5 = Color.FromArgb(255, 252, 229);
        protected static Color _r6 = Color.FromArgb(255, 235, 166);
        protected static Color _r7 = Color.FromArgb(255, 213, 103);
        protected static Color _r8 = Color.FromArgb(255, 228, 145);
        protected static Color _r9 = Color.FromArgb(160, 188, 228);
        protected static Color _rA = Color.FromArgb(121, 153, 194);
        protected static Color _rB = Color.FromArgb(182, 190, 192);
        protected static Color _rC = Color.FromArgb(155, 163, 167);
        protected static Color _rD = Color.FromArgb(233, 168, 97);
        protected static Color _rE = Color.FromArgb(247, 164, 39);
        protected static Color _rF = Color.FromArgb(246, 156, 24);
        protected static Color _rG = Color.FromArgb(253, 173, 17);
        protected static Color _rH = Color.FromArgb(254, 185, 108);
        protected static Color _rI = Color.FromArgb(253, 164, 97);
        protected static Color _rJ = Color.FromArgb(252, 143, 61);
        protected static Color _rK = Color.FromArgb(255, 208, 134);
        protected static Color _rL = Color.FromArgb(249, 192, 103);
        protected static Color _rM = Color.FromArgb(250, 195, 93);
        protected static Color _rN = Color.FromArgb(248, 190, 81);
        protected static Color _rO = Color.FromArgb(255, 208, 49);
        protected static Color _rP = Color.FromArgb(254, 214, 168);
        protected static Color _rQ = Color.FromArgb(252, 180, 100);
        protected static Color _rR = Color.FromArgb(252, 161, 54);
        protected static Color _rS = Color.FromArgb(254, 238, 170);
        protected static Color _rT = Color.FromArgb(249, 202, 113);
        protected static Color _rU = Color.FromArgb(250, 205, 103);
        protected static Color _rV = Color.FromArgb(248, 200, 91);
        protected static Color _rW = Color.FromArgb(255, 218, 59);
        protected static Color _rX = Color.FromArgb(254, 185, 108);
        protected static Color _rY = Color.FromArgb(252, 161, 54);
        protected static Color _rZ = Color.FromArgb(254, 238, 170);

        // Color scheme values
        protected static Color _textDisabled = _c1;
        protected static Color _textMenuStripItem = _c2;
        protected static Color _textStatusStripItem = _c2;
        protected static Color _textContextMenuItem = _c2;
        protected static Color _arrowDisabled = _c1;
        protected static Color _arrowLight = Color.FromArgb(106, 126, 197);
        protected static Color _arrowDark = Color.FromArgb(64, 70, 90);
        protected static Color _separatorMenuLight = Color.FromArgb(245, 245, 245);
        protected static Color _separatorMenuDark = Color.FromArgb(197, 197, 197);
        protected static Color _contextMenuBack = _c4;
        protected static Color _contextCheckBorder = Color.FromArgb(242, 149, 54);
        protected static Color _contextCheckTick = Color.FromArgb(66, 75, 138);
        protected static Color _statusStripBorderDark = Color.FromArgb(86, 125, 176);
        protected static Color _statusStripBorderLight = Color.White;
        protected static Color _gripDark = Color.FromArgb(114, 152, 204);
        protected static Color _gripLight = _c5;
        public static GradientItemColors _itemContextItemEnabledColors = new GradientItemColors(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, Color.FromArgb(217, 203, 150), Color.FromArgb(192, 167, 118));
        public static GradientItemColors _itemDisabledColors = new GradientItemColors(_c4, _c6, Color.FromArgb(236, 236, 236), Color.FromArgb(230, 230, 230), _c6, Color.FromArgb(224, 224, 224), Color.FromArgb(200, 200, 200), Color.FromArgb(210, 210, 210), Color.FromArgb(212, 212, 212), Color.FromArgb(195, 195, 195));
        public static GradientItemColors _itemToolItemSelectedColors = new GradientItemColors(_r1, _r2, _r3, _r4, _r5, _r6, _r7, _r8, _r9, _rA);
        public static GradientItemColors _itemToolItemPressedColors = new GradientItemColors(_rD, _rE, _rF, _rG, _rH, _rI, _rJ, _rK, _r9, _rA);
        public static GradientItemColors _itemToolItemCheckedColors = new GradientItemColors(_rL, _rM, _rN, _rO, _rP, _rQ, _rR, _rS, _r9, _rA);
        public static GradientItemColors _itemToolItemCheckPressColors = new GradientItemColors(_rT, _rU, _rV, _rW, _rX, _rI, _rY, _rZ, _r9, _rA);
        #endregion
        ...
        protected void RenderToolButtonBackground(Graphics g,
        ...
        protected void RenderToolDropButtonBackground(Graphics g,
                                                    ToolStripItem item, 
                                                    ToolStrip toolstrip)
        {
            // We only draw a background if the item is selected or being pressed
        ...
        protected void RenderToolSplitButtonBackground(Graphics g,
        ...
        protected void DrawGradientToolItem(Graphics g, 
                                          ToolStripItem item, 
        ...
        protected void DrawGradientToolSplitItem(Graphics g,
                                               ToolStripSplitButton splitButton, 
        ...
        protected void DrawContextMenuHeader(Graphics g, ToolStripItem item)
        {
        ...
        protected void DrawGradientContextMenuItem(Graphics g,
                                                 ToolStripItem item,
                                                 GradientItemColors colors)
        {
            // Do we need to draw with separator on the opposite edge?
        ...
        protected void DrawGradientItem(Graphics g, 
                                      Rectangle backRect, 
                                      GradientItemColors colors)
        {
            // Cannot paint a zero sized area
        ...
        public void DrawGradientBack(Graphics g, 
                                      Rectangle backRect,
                                      GradientItemColors colors)  
        {
        ...
        protected void DrawGripGlyph(Graphics g, 
                                   int x, 
                                   int y, 
                                   Brush darkBrush, 
                                   Brush lightBrush)
        ...
        protected GraphicsPath CreateBorderPath(Rectangle rect,
                                              Rectangle exclude,
                                              float cut)
        {
        ...
        protected GraphicsPath CreateBorderPath(Rectangle rect, float cut)
        {
            // Drawing lines requires we draw inside the area we want
            rect.Width--;
            rect.Height--;
        ...
        protected GraphicsPath CreateInsideBorderPath(Rectangle rect, float cut)
        {
        ...
        protected GraphicsPath CreateInsideBorderPath(Rectangle rect,
                                                    Rectangle exclude,
                                                    float cut)
        {
            // Adjust rectangle to be 1 pixel inside the original area
        ...
        protected GraphicsPath CreateClipBorderPath(Rectangle rect, float cut)
        {
        ...
        protected GraphicsPath CreateClipBorderPath(Rectangle rect,
                                                  Rectangle exclude,
                                                  float cut)
        {
            // Clipping happens inside the rect, so make 1 wider and taller
        ...
        protected GraphicsPath CreateArrowPath(ToolStripItem item,
                                             Rectangle rect, 
        ...
        protected GraphicsPath CreateTickPath(Rectangle rect)
        {
        ...
        protected GraphicsPath CreateIndeterminatePath(Rectangle rect)
        {
            // Get the center point of the rect
            int x = rect.X + rect.Width / 2;
            int y = rect.Y + rect.Height / 2;
