...
# include "jingxian/protocol/SOCKSv5Incoming.h"
# include "jingxian/protocol/SOCKSv5Outgoing.h"

_jingxian_begin

    class SOCKSv5Protocol : public BaseProtocol
    {
        BaseProtocol _peer = null;
        IOBuffer _buffer = null;
        ...
        IAcceptor _acceptor = null;

        public SOCKSv5(Proxy server)
        {
            _server = server;
        }
        ...
        public override void OnReceived(ProtocolContext context, IOBuffer IOBuffer)
        {
            _dataReceived(context, IOBuffer);
        }
