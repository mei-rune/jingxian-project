...
inline void create_thread( const F& f, const P1& x1, const P2& x2, const tchar* nm = null_ptr)
{
...
inline void create_thread( const F& f, const P1& x1, const P2& x2, const P3& x3, const tchar* nm = null_ptr)
{
