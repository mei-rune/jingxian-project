...
namespace jingxian.core.runtime
{
    ...
    {
        object ConvertTo(object parameter, IRuntimeContext context);
    }
    ...
    public interface IConvertSystem
    {
        ...
        object ConvertTo(object parameter, Type to_type, IRuntimeContext context);
    }
    ...
    public class Converter : IConvertSystem
    {
        ...
        public object ConvertTo(object parameter, Type type, IRuntimeContext context)
        {
            if (null == parameter)
                return null;
            ...
            if (_converters.TryGetValue(type, out converter) && null != converter)
                return converter.ConvertTo(parameter, context);
            converter = GetConverterFrom(parameter as IProperties);
            if (null != converter)
                converter.ConvertTo(parameter, context);

            object instance = Utils.CreateObjectFromProperites(parameter as IProperties, type, this);
            if (null != instance)
                return instance;
        ...
        public IConverter Find(object parameter, Type type)
        {
            ...
            return GetConverterFrom(parameter as IProperties);
        }

        IConverter GetConverterFrom(IProperties properties)
        {
            if (null == properties)
                return null;
            string name = Utils.GetAsString(properties, "converter");
        ...
        public class DefaultConverter : IConverter
        {
            ...
            public object ConvertTo(object parameter, IRuntimeContext context)
            {
        ...
        public class MethodConverter : IConverter
        {
            ...
            public object ConvertTo(object parameter, IRuntimeContext context)
            {
                return _methodInfo.Invoke(Instance, new object[] { parameter, context });
            }
        }
